...
namespace BitmUniversityApp.Controllers
{
    public class TeacherController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="Id,TeacherName,TeacherAddress,TeacherEmail,TeacherContactNo,DesignationId,DepartmentId,CreditTaken")] Teacher teacher)
        {
