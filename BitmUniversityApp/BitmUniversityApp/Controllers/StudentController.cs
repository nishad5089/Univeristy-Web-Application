...
namespace BitmUniversityApp.Controllers
{
    public class StudentController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="Id,Name,Email,ContactNo,Date,Address,DepartmentId,StudentRegNo")] Student student)
        {
        ...
        {
            var cnt =
                db.Students.Count(m => (m.DepartmentId == aStudent.DepartmentId) && (m.Date.Year == aStudent.Date.Year))+1;

          var aDepartment = db.Students.FirstOrDefault(m => m.Department.Id == aStudent.DepartmentId);
            ...
            string studentRegNo = aDepartment.Department.DeptCode + "-" + aStudent.Date.Year + "-" + leadingZero + cnt;
            return studentRegNo;
        }
    }
}
